...
import com.ipa.spring.mongodb.model.Person;
import com.mongodb.MongoClient;

public class SpringDataMongoDBMain {

	public static final String DB_NAME = "ipa";
	...
	public static void main(String[] args) {
		try {
			...
			Person p = new Person("1", "Amir Saguy", "Tel Aviv, Israel");
			mongoOps.insert(p, PERSON_COLLECTION);

			Person p1 = mongoOps.findOne(
					new Query(Criteria.where("name").is("Amir Saguy")),
